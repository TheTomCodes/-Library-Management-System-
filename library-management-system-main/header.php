...
<html lang="en">
    <head>
        ...
        <title>The Library Management System</title>
        ...
        <script src="../asset/js/font-awesome-5-all.min.js" crossorigin="anonymous"></script>
        <!-- Favicons -->
        <link rel="icon" type="image/x-icon" href="asset/images/Library.png">
    			...
    			<header class="pb-3 mb-4 border-bottom">
                    <div>
                        <div style="display: flex">
                            <img src="asset/images/Library.png" style="height: 100px; width: 100px" alt="logo">
        			    <div>
                            <a href="index.php" class="d-flex align-items-center text-dark text-decoration-none">
                                <span class="fs-4" style= "width: 90%">The Library Mangement System</span>
                            </a>
                        </div>
                            <?php 
